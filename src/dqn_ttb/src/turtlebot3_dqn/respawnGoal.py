...
class Respawn():
    def __init__(self):
        ...
        self.modelPath = self.modelPath.replace('turtlebot3_machine_learning/src/dqn_ttb/src/turtlebot3_dqn','turtlebot3_simulations/turtlebot3_gazebo/models/turtlebot3_square/goal_box/model.sdf')
